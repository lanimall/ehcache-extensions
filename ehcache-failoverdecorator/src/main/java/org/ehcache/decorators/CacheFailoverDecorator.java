...
public class CacheFailoverDecorator extends EhcacheDelegateAdapter {
	private static final Logger log = LoggerFactory.getLogger(CacheFailoverDecorator.class);
	...
	public CacheFailoverDecorator(Ehcache underlyingCache, Properties properties) {
	...
	private class GetOp implements Callable<Element> {
		...
		public Element call() {
			return CacheFailoverDecorator.this.get(key);
		}
	}
